...
def cache_soup(soup, ra_number, cache_dir):
    ...
    # add the following html to the soup
    lexsearch_html = '''
    <div id="lexsearch" style="font-size: 80%; text-align: center;">
    <p>This page was generated by Lex Search, a free and open source tool for searching Philippine laws and jurisprudence.</p>
    <p>For more information, visit <a href="https://github.com/roelchristian/lexsearch"> the project's GitHub page</a>.</p>
    '''
